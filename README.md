...
当前已完成 Stage 1 基础业务系统、Stage 2 只读 Tool System、Stage 3 Qwen Tool Calling + Agent Loop、Stage 4 多工具运营分析、Stage 5 多轮 Conversation Memory 和 Stage 6 单商品改价审批及审计。启动 Agent 前需设置进程环境变量 `DASHSCOPE_API_KEY`；模型默认 `qwen-plus`，最多调用 6 次，会话历史默认最多加载 20 条。详见 [docs/stage1.md](docs/stage1.md)、[docs/stage2.md](docs/stage2.md)、[docs/stage3.md](docs/stage3.md)、[docs/stage4.md](docs/stage4.md)、[docs/stage5.md](docs/stage5.md) 和 [docs/stage6.md](docs/stage6.md)。
